<div class="row">
    <div class="col-md-5">
        ...
        <form method="post" action="index.php?page=Eleve" class="form-horizontal">
            ...
            <div class="row">
                <div class="form-group">
                    ...
                    <!--<div class="radio">-->
                    <label class="radio control-label"><input type="radio" name="sexe" value="m" <?php if ($sexe == 'm') { ?>checked<?php } ?>>Garçon</label>
                    <!--</div>-->
                    <!--<div class="radio">-->
                    <label class="radio control-label"><input type="radio" name="sexe" value="f" <?php if ($sexe == 'f') { ?>checked<?php } ?>>Fille</label>
                    <!--</div>-->
                </div>  
            </div>
            ...
            <div class="row">
                ...
                <div class="row">
                    <div class="form-group">
                        <?php if (array_key_exists('role', $_SESSION)): ?>    
                            <label for="classe" class="col-md-4 control-label">Mettre à jour la classe:</label>
                            <div class="col-md-3">
